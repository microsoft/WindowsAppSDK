...
If you have your own installer, we have [instructions](https://docs.microsoft.com/en-us/windows/apps/windows-app-sdk/deploy-unpackaged-apps) to carry the Windows App SDK components with your app
