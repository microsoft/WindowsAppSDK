...
and start coding. For example, some parts of the Windows App SDK work _better_ if your app is a [Desktop Bridge](https://docs.microsoft.com/windows/apps/desktop/modernize/desktop-to-uwp-extensions),
