...
enum UnitTest { channelRequestUsingNullRemoteId, channelRequestUsingRemoteId, multipleChannelRequestUsingSameRemoteId,
...
bool ChannelRequestUsingNullRemoteId()
{
    ...
    try
    {
        auto channelOperation = PushNotificationManager::CreateChannelAsync(GUID_NULL);
    }
    catch (...)
    {
