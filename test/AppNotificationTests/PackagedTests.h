...
class PackagedTests : BaseTestSuite
{
    ...
    TEST_CLASS_SETUP(ClassInit)
    {
        ...
        {
            WEX::Logging::Log::Result(WEX::Logging::TestResults::Skipped, L"AppNotification::PackagedTests require Win10 19H1 or greater due to COM registration compatibility. Skipping tests on this OS version.");
            return true;
        }
