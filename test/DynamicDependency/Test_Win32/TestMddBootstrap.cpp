...
namespace Test::DynamicDependency
{
    ...
    public:
        ...
        TEST_METHOD(Initialize_DDLMNotFound)
        {
            ...
            VERIFY_ARE_EQUAL(E_FAIL, MddBootstrapInitialize(doesNotExist, nullptr, minVersionMatchAny));
        }
        ...
        TEST_METHOD(Initialize_DDLMMinVersionNoMatch)
        {
            ...
            VERIFY_ARE_EQUAL(E_FAIL, MddBootstrapInitialize(c_Version_MajorMinor, nullptr, minVersionNoMatch));
        }
        ...
        TEST_METHOD(Initialize2xIncompatible)
        {
            ...
            VERIFY_ARE_EQUAL(E_FAIL, MddBootstrapInitialize(c_Version_MajorMinor_Incompatible, nullptr, c_minVersion));

            VERIFY_ARE_EQUAL(E_INVALIDARG, MddBootstrapInitialize(c_Version_MajorMinor, L"MakesPackageFamilyNameTooLong", c_minVersion));
            VERIFY_ARE_EQUAL(E_FAIL, MddBootstrapInitialize(c_Version_MajorMinor, L"Zathras", c_minVersion));

            const PACKAGE_VERSION c_minVersion_Incompatible{ UINT64_MAX };
            VERIFY_ARE_EQUAL(E_FAIL, MddBootstrapInitialize(c_Version_MajorMinor, nullptr, c_minVersion_Incompatible));
        ...
        TEST_METHOD(InitializeShutdownMultiple)
        {
            ...
            VERIFY_ARE_EQUAL(E_FAIL, MddBootstrapInitialize(c_Version_MajorMinor3, L"NoSuchShortVersionTagActuallUsedByAnyPackageAndEvenIfTherIsThePackageFamilyNameWouldBeTooLong", c_minVersion3));
            VERIFY_ARE_EQUAL(E_FAIL, MddBootstrapInitialize(c_Version_MajorMinor3, L"Zathras", c_minVersion3));
            ...
            VERIFY_ARE_EQUAL(E_FAIL, MddBootstrapInitialize(c_Version_MajorMinor4, nullptr, c_minVersion4));
