...
namespace HelloWorldAdvancedCS
{
    class Program
    {
        static void Help()
        {
            var help = new string[]{
                "Usage: HelloWorldAdvancedCS.exe [options] <majorminor> [<tag> [<minversion>]]",
                "options:",
                ...
                "  HelloWorldAdvancedCS.exe 1.0 experimental 0.218.840.0",
                "Use Windows App SDK 1.0 (stable), minVersion=0 (any)",
                "  HelloWorldAdvancedCS.exe 0x00010000 0\"\"",
                "Use Windows App SDK 1.1-experimental2, minVersion=0 (any)",
                "  HelloWorldAdvancedCS.exe 1.1 experimental2 0",
                "  or",
                "  HelloWorldAdvancedCS.exe 1.1 experimental"
            };
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                Console.WriteLine($"Bootstrap.Initialize({majorMinorVersion:X08}, \"{versionTag}\", {minVersion.Major}.{minVersion.Minor}.{minVersion.Build}.{minVersion.Revision}, 0x{(int)options:X08})...");
                Bootstrap.Initialize(majorMinorVersion, versionTag, minVersion, options);
            }
            catch (Exception e)
            {
