...
int Help()
{
    printf("Usage: HelloWorldAdvancedC.exe [options] <majorminor> [<tag> [<minversion>]]\n"
        ...
        "  HelloWorldAdvancedC.exe 1.0 experimental 0.218.840.0\n"
        "Use Windows App SDK 1.0 (stable), minVersion=0 (any)\n"
        "  HelloWorldAdvancedC.exe 0x00010000 0\"\"\n"
        "Use Windows App SDK 1.1-experimental2, minVersion=0 (any)\n"
        "  HelloWorldAdvancedC.exe 1.1 experimental2 0\n"
        "  or\n"
        "  HelloWorldAdvancedC.exe 1.1 experimental\n");
    return 1;
}
...
int wmain(int argc, wchar_t* argv[])
{
    ...
    {
        majorMinorVersion = wcstoul(arg + 2, nullptr, 16);
    }
    else
    {
        UINT16 versionMajor{};
        ...
        {
            majorMinorVersion = wcstoul(arg, nullptr, 10);
        }
    }
    ...
    if (argn < argc)
    {
        ...
        if (arg[0] == L'0' && arg[1] == L'x')
        {
            minVersion.Version = wcstoull(arg, nullptr, 16);
        }
