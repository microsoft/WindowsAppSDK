...
void Test::DynamicDependency::Test_WinRT::FullLifecycle_FilePathLifetime_Frameworks_WindowsAppSDK_MathAdd()
{
    ...
    VerifyPathEnvironmentVariable(packagePath_WindowsAppSDKFramework, packagePath_FrameworkMathAdd, packagePath_FrameworkMathAdd, pathEnvironmentVariable.c_str());
    VerifyPackageDependency(packageDependencyId_FrameworkMathAdd, S_OK, expectedPackageFullName_FrameworkMathAdd);
