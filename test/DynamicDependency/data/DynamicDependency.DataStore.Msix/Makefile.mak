...
$(OutMsix): $(ProjectDir)appxmanifest.xml
    ...
    @copy /Y $(OutDir)PushNotificationsLongRunningTask\PushNotificationsLongRunningTask.exe $(WorkDir)\PushNotificationsLongRunningTask.exe
    @copy /Y $(OutDir)PushNotificationsLongRunningTask\PushNotificationsLongRunningTask.pdb $(WorkDir)\PushNotificationsLongRunningTask.pdb
