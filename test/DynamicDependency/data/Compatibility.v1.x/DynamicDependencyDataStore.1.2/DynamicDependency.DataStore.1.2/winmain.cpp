...
struct __declspec(uuid(PR_DYNDEP_DATASTORE_1X_CLSID_STRING)) DynamicDependencyDataStoreImpl WrlFinal : RuntimeClass<RuntimeClassFlags<ClassicCom>, IDynamicDependencyDataStore>
{
