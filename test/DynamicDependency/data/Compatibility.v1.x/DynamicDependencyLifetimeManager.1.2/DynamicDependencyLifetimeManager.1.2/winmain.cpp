...
static constexpr GUID DynamicDependencyLifetimeManager_guid { PR_DYNDEP_LIFETIMEMANAGER_1X_CLSID_GUID };

struct __declspec(uuid(PR_DYNDEP_LIFETIMEMANAGER_1X_CLSID_STRING)) DynamicDependencyLifetimeManagerImpl WrlFinal : RuntimeClass<RuntimeClassFlags<ClassicCom>, IDynamicDependencyLifetimeManager>
{
