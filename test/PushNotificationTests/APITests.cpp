...
namespace Test::PushNotifications
{
    ...
    private:
        ...
        const std::wstring c_testPackageFile = g_deploymentDir + L"PushNotificationsTestAppPackage_1.0.1.0_x64.msixbundle";
        const std::wstring c_testPackageCertFile = g_deploymentDir + L"PushNotificationsTestAppPackage_1.0.1.0_x64.cer";
        const std::wstring c_testPackageFullName = L"PushNotificationsTestAppPackage_1.0.1.0_x64__8wekyb3d8bbwe";
