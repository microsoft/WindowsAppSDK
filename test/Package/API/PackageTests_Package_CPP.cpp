...
namespace Test::Package::Tests
{
    ...
    public:
        ...
        TEST_METHOD(GetPackageFilePath_FilterPackageType_Main_Match)
        {
        ...
        TEST_METHOD(GetPackageFilePath_FilterPackageType_Main_Main_Match)
        {
            PCWSTR packageFullName{ Main_PackageFullName };
            PCWSTR fileName{ L"AppxManifest.xml" };
        ...
        TEST_METHOD(GetPackageFilePath_FilterPackageType_Main_InstallMain_Match)
        {
            PCWSTR packageFullName{ Main_PackageFullName };
            PCWSTR fileName{ L"AppxManifest.xml" };
            const auto options{ GetPackageFilePathOptions_SearchInstallPath |
        ...
        TEST_METHOD(GetPackageFilePath_FilterPackageType_Main_Mutable_MutableFramework_NoMatch)
        {
            PCWSTR packageFullName{ Main_PackageFullName };
            PCWSTR fileName{ L"Shadow.cat" };
            const auto options{ GetPackageFilePathOptions_SearchMutablePath |
        ...
        TEST_METHOD(GetPackageFilePath_FilterPackageType_Main_Mutable_Mutable_NoMatch)
        {
            PCWSTR packageFullName{ Main_PackageFullName };
            PCWSTR fileName{ L"Shadow.cat" };
            const auto options{ GetPackageFilePathOptions_SearchMutablePath };
        ...
        TEST_METHOD(GetPackageFilePath_FilterPackageType_Main_Framework_NoMatch)
        {
            PCWSTR packageFullName{ Main_PackageFullName };
            PCWSTR fileName{ L"Shadow.cat" };
        ...
        TEST_METHOD(GetPackageFilePath_FilterPackageType_Main_InstallFramework_NoMatch)
        {
            PCWSTR packageFullName{ Main_PackageFullName };
            PCWSTR fileName{ L"Shadow.cat" };
            const auto options{ GetPackageFilePathOptions_SearchInstallPath |
        ...
        TEST_METHOD(GetPackageFilePath_FilterPackageType_Framework_Match)
        {
            PCWSTR packageFullName{ Framework_PackageFullName };
            PCWSTR fileName{ L"AppxManifest.xml" };
            const auto options{ GetPackageFilePathOptions_None };
        ...
        TEST_METHOD(GetPackageFilePath_FilterPackageType_Framework_Framework_Match)
        {
            PCWSTR packageFullName{ Framework_PackageFullName };
            PCWSTR fileName{ L"AppxManifest.xml" };
            const auto options{ GetPackageFilePathOptions_SearchFrameworkPackages };
        ...
        TEST_METHOD(GetPackageFilePath_FilterPackageType_Framework_InstallFramework_Match)
        {
            PCWSTR packageFullName{ Framework_PackageFullName };
            PCWSTR fileName{ L"AppxManifest.xml" };
            const auto options{ GetPackageFilePathOptions_SearchInstallPath |
        ...
        TEST_METHOD(GetPackageFilePath_FilterPackageType_Framework_MutableMain_NoMatch)
        {
            PCWSTR packageFullName{ Framework_PackageFullName };
            PCWSTR fileName{ L"Shadow.cat" };
            const auto options{ GetPackageFilePathOptions_SearchMutablePath |
        ...
        TEST_METHOD(GetPackageFilePath_FilterPackageType_Framework_Mutable_NoMatch)
        {
            PCWSTR packageFullName{ Framework_PackageFullName };
            PCWSTR fileName{ L"Shadow.cat" };
            const auto options{ GetPackageFilePathOptions_SearchMutablePath };
        ...
        TEST_METHOD(GetPackageFilePath_FilterPackageType_Framework_Main_NoMatch)
        {
            PCWSTR packageFullName{ Framework_PackageFullName };
            PCWSTR fileName{ L"Shadow.cat" };
            const auto options{ GetPackageFilePathOptions_SearchMainPackages };
        ...
        TEST_METHOD(GetPackageFilePath_FilterPackageType_Framework_InstallMain_NoMatch)
        {
            PCWSTR packageFullName{ Framework_PackageFullName };
            PCWSTR fileName{ L"Shadow.cat" };
            const auto options{ GetPackageFilePathOptions_SearchInstallPath |
