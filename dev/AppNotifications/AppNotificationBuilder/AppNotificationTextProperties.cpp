...
namespace winrt::Microsoft::Windows::AppNotifications::Builder::implementation
{
    ...
    winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationTextProperties AppNotificationTextProperties::SetStyle(AppNotificationTextStyle const& value)
    {
        m_style = value;
    ...
    winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationTextProperties AppNotificationTextProperties::SetWrap()
    {
        return *this;
    }

    winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationTextProperties AppNotificationTextProperties::SetMinLines(int const& /*value*/)
    {
        return *this;
    }

    winrt::Microsoft::Windows::AppNotifications::Builder::AppNotificationTextProperties AppNotificationTextProperties::SetAlign(AppNotificationTextAlign const& value)
    {
        m_align = value;
    ...
    std::wstring AppNotificationTextProperties::StyleToString()
    {
        std::wstring style{};
    ...
    std::wstring AppNotificationTextProperties::AlignToString()
    {
        std::wstring align{};
