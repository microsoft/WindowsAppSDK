...
Microsoft::ApplicationModel::Resources::ResourceMap ResourceManager::MainResourceMap()
{
    return winrt::make<ResourceMap>(*this, m_resourceManagerHandle, nullptr);
}

Microsoft::ApplicationModel::Resources::ResourceContext ResourceManager::CreateResourceContext()
{
...
winrt::event_token ResourceManager::ResourceNotFound(Windows::Foundation::TypedEventHandler<
...
Microsoft::ApplicationModel::Resources::ResourceCandidate ResourceManager::HandleResourceNotFound(
    Microsoft::ApplicationModel::Resources::ResourceContext context,
    hstring name)
{
    Microsoft::ApplicationModel::Resources::ResourceNotFoundEventArgs args = winrt::make<ResourceNotFoundEventArgs>(context, name);
    m_resourceNotFound(*this, args);
    Microsoft::ApplicationModel::Resources::ResourceCandidate candidate = args.as<ResourceNotFoundEventArgs>()->GetResolvedCandidate();
    if (candidate != nullptr)
    {
        candidate.as<winrt::Microsoft::ApplicationModel::Resources::implementation::ResourceCandidate>()->SetQualifierValuesFromContext(context);
    }
