...
Microsoft::ApplicationModel::Resources::ResourceCandidateKind ResourceCandidate::Kind() { return m_kind; }

Windows::Foundation::Collections::IMapView<hstring, hstring> ResourceCandidate::QualifierValues()
{
...
void ResourceCandidate::SetQualifierValuesFromContext(Microsoft::ApplicationModel::Resources::ResourceContext context)
{
    Windows::Foundation::Collections::IMap<hstring, hstring> qualifierValues = context.QualifierValues();
    m_qualifierValueMap = single_threaded_map<hstring, hstring>();
