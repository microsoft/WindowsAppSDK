...
using namespace winrt::Microsoft::WindowsApp;
...
Microsoft::WindowsApp::Resources::ResourceCandidate ResourceMap::TryGetValue(hstring const& resource)
{
    return GetValueImpl(nullptr, resource, true);
}

Microsoft::WindowsApp::Resources::ResourceCandidate ResourceMap::TryGetValue(hstring const& resource, Microsoft::WindowsApp::Resources::ResourceContext const& context)
{
...
{
    // Always use a context as we override the languages.
    Microsoft::WindowsApp::Resources::ResourceContext resourceContext =
    ...
    case MrmType_Path:
    {
        ...
        return winrt::make<winrt::impl::key_value_pair<
            Windows::Foundation::Collections::IKeyValuePair<hstring, Microsoft::WindowsApp::Resources::ResourceCandidate>>>(
