...
Microsoft::WindowsApp::Resources::ResourceCandidateKind ResourceCandidate::Kind() { return m_kind; }
...
void ResourceCandidate::SetQualifierValuesFromContext(Microsoft::WindowsApp::Resources::ResourceContext context)
{
