...
#define WRITE_MRMMIN_INIT_TRACE_INFO_CHECK(msg, hr) \
    { \
        MrtRuntimeTraceLoggingProvider::TelemetryGenericEvent(TOWIDE(__FUNCTION__), RemovePiiFromString(msg), hr); \
    }
...
#define WRITE_MRMMIN_INIT_TRACE_ERROR_MEASURE_CHECK(msg, hr) \
    { \
        LOG_ERROR_IN_MEMORY(hr, __LINE__, __FILE__, msg); \
        MrtRuntimeTraceLoggingProvider::MeasureGenericEvent(TOWIDE(__FUNCTION__), RemovePiiFromString(msg), hr); \
    }
...
#define WRITE_MRMMIN_TRACE_WARNING_CHECK(msg, msg2, hr) \
    { \
        MrtRuntimeTraceLoggingProvider::TelemetryGenericEvent(TOWIDE(__FUNCTION__), msg, RemovePiiFromString(msg2), hr); \
    }
...
#define WRITE_MRMMIN_TRACE_ERROR_MEASURE_CHECK(msg, msg2, hr) \
    { \
        LOG_ERROR_IN_MEMORY(hr, __LINE__, __FILE__, msg2); \
        MrtRuntimeTraceLoggingProvider::MeasureGenericEvent(TOWIDE(__FUNCTION__), msg, RemovePiiFromString(msg2), hr); \
    }
