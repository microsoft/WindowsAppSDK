...
namespace winrt::Microsoft::ProjectReunion::implementation
{
    struct PushNotificationChannelManager
    {
        ...
        static Windows::Foundation::IAsyncOperationWithProgress<Microsoft::ProjectReunion::PushChannelResult, Microsoft::ProjectReunion::PushChannelResult> CreatePushNotificationChannelAsync(hstring remoteId);
    };
}
