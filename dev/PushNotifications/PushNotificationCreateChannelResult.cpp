...
namespace winrt::Microsoft::ProjectReunion::implementation
{
    ...
    void PushNotificationCreateChannelResult::PushNotificationCreateChannelUpdate(Microsoft::ProjectReunion::PushNotificationChannel const& channel, winrt::hresult const& extendedError, Microsoft::ProjectReunion::PushNotificationChannelStatus const& status)
    {
        m_channel = channel;
        m_extendedError = extendedError;
        m_status = status;
