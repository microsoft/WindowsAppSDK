...
namespace winrt::Microsoft::Windows::PushNotifications::implementation
{
    ...
    winrt::IAsyncOperationWithProgress<winrt::Microsoft::Windows::PushNotifications::PushNotificationCreateChannelResult, winrt::Microsoft::Windows::PushNotifications::PushNotificationCreateChannelStatus> PushNotificationManager::CreateChannelAsync(const winrt::guid remoteId)
    {
        ...
        auto logTelemetry = PushNotificationTelemetry::CreateChannelAsync::Start(m_telemetryHelper, remoteId);
    ...
    void PushNotificationManager::Register()
    {
        ...
        auto logTelemetry = PushNotificationTelemetry::Register::Start(m_telemetryHelper);
    ...
    void PushNotificationManager::Unregister()
    {
        ...
        auto logTelemetry = PushNotificationTelemetry::Unregister::Start(m_telemetryHelper);
    ...
    void PushNotificationManager::UnregisterAll()
    {
        ...
        auto logTelemetry = PushNotificationTelemetry::UnregisterAll::Start(m_telemetryHelper);
    ...
    {
        auto logTelemetry = PushNotificationTelemetry::InvokeAll::Start(m_telemetryHelper);
    ...
    {
        auto logTelemetry = PushNotificationTelemetry::OnRawNotificationReceived::Start(m_telemetryHelper, wil::str_raw_ptr(correlationVector));
