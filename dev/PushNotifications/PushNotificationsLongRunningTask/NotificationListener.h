...
class NotificationListener : public Microsoft::WRL::RuntimeClass<::ABI::Microsoft::Internal::PushNotifications::INotificationListener, ::ABI::Microsoft::Internal::PushNotifications::INotificationListener2>
{
public:
    HRESULT RuntimeClassInitialize(std::shared_ptr<ForegroundSinkManager> foregroundSinkManager, std::shared_ptr<ToastRegistrationManager> toastRegistrationManager, std::wstring appId, std::wstring processName);
