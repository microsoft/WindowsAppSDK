...
namespace WindowsAppSDK.Cpp.Extension.Dev17 {
    ...
    internal class VSPackage {
        ...
        /// <summary>
        ///   Looks up a localized string similar to [{0}] Unable to add references to the following packages: {1}.
        ///
        ///This is an environment error. Please add package references before building the project.
        ///
        ///For more details on the error, check the General tab in the Output window..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to [{0}] NuGet package auto-download is disabled. Unable to install: {1}. Click &quot;Manage NuGet Packages&quot; below to install the required packages manually..
        /// </summary>
