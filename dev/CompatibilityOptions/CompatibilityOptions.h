...
namespace winrt::Microsoft::Windows::ApplicationModel::WindowsAppRuntime::implementation
{
    struct CompatibilityOptions : CompatibilityOptionsT<CompatibilityOptions>
    {
        ...
        winrt::Windows::Foundation::Collections::IVector<uint64_t> DisabledChanges();
    ...
    private:
        ...
        winrt::Windows::Foundation::Collections::IVector<uint64_t> m_disabledChanges{ winrt::single_threaded_vector<uint64_t>() };
    };
}
