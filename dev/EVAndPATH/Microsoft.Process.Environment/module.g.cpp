...
void* winrt_make_Microsoft_Process_Environment_EnvironmentManager();
...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"Microsoft.Process.Environment.EnvironmentManager"))
    {
        return winrt_make_Microsoft_Process_Environment_EnvironmentManager();
    }
