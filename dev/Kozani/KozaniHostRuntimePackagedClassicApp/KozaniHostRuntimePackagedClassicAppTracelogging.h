...
class WindowsAppRuntimeKozaniHostRuntimePackagedClassicApp_TraceLogger final : public wil::TraceLoggingProvider
{
    IMPLEMENT_TRACELOGGING_CLASS(
        WindowsAppRuntimeKozaniHostRuntimePackagedClassicApp_TraceLogger,
        "Microsoft.WindowsAppRuntime.KozaniHostRuntimePackagedClassicApp",
...
#define KozaniHostRuntimePackagedClassicApp_TraceLoggingWString(_wstring_, _name_) TraceLoggingCountedWideString(_wstring_.c_str(),\
...
#define KozaniHostRuntimePackagedClassicApp_WriteEventWithActivity(_eventname_,_activityId_,...) TraceLoggingWriteActivity(\
        WindowsAppRuntimeKozaniHostRuntimePackagedClassicApp_TraceLogger::Provider(),\
        _eventname_,\
        _activityId_,\
        nullptr,\
        _WRITE_FAILURE_INFO,\
