...
class WindowsAppRuntimeKozaniSendToLocal_TraceLogger final : public wil::TraceLoggingProvider
{
    IMPLEMENT_TRACELOGGING_CLASS(
        WindowsAppRuntimeKozaniSendToLocal_TraceLogger,
        "Microsoft.WindowsAppRuntime.KozaniSendToLocal",
...
#define KozaniSendToLocal_TraceLoggingWString(_wstring_, _name_) TraceLoggingCountedWideString(_wstring_.c_str(),\
...
#define KozaniSendToLocal_WriteEventWithActivity(_eventname_,_activityId_,...) TraceLoggingWriteActivity(\
        WindowsAppRuntimeKozaniSendToLocal_TraceLogger::Provider(),\
        _eventname_,\
        _activityId_,\
        nullptr,\
        _WRITE_FAILURE_INFO,\
