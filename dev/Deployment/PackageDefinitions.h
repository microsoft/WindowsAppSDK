...
namespace winrt::Microsoft::Windows::ApplicationModel::WindowsAppRuntime::implementation
{
    ...
    {
        { WINDOWSAPPRUNTIME_PACKAGE_NAME_ALT_PREFIX, WINDOWSAPPRUNTIME_PACKAGE_SUBTYPENAME_MAIN },
        { WINDOWSAPPRUNTIME_PACKAGE_NAME_ALT_PREFIX, WINDOWSAPPRUNTIME_PACKAGE_SUBTYPENAME_SINGLETON },
