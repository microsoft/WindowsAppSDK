...
#define MICROSOFT_WINDOWS_AI_TEXT_TEXTINTELLIGENCECONTRACT_VERSION 0x70000
...
#ifndef ____x_ABI_CMicrosoft_CWindows_CAI_CText_CITextRewriter3_FWD_DEFINED__
#define ____x_ABI_CMicrosoft_CWindows_CAI_CText_CITextRewriter3_FWD_DEFINED__
namespace ABI {
    namespace Microsoft {
        namespace Windows {
            namespace AI {
                namespace Text {
                    interface ITextRewriter3;
                } /* Text */
            } /* AI */
        } /* Windows */
    } /* Microsoft */
} /* ABI */
#define __x_ABI_CMicrosoft_CWindows_CAI_CText_CITextRewriter3 ABI::Microsoft::Windows::AI::Text::ITextRewriter3

#endif // ____x_ABI_CMicrosoft_CWindows_CAI_CText_CITextRewriter3_FWD_DEFINED__
...
/*
 *
 * Interface Microsoft.Windows.AI.Text.ITextRewriter3
 *
 * Introduced to Microsoft.Windows.AI.Text.TextIntelligenceContract in version 7.0
 *
 * Interface is a part of the implementation of type Microsoft.Windows.AI.Text.TextRewriter
 *
 */
#if MICROSOFT_WINDOWS_AI_TEXT_TEXTINTELLIGENCECONTRACT_VERSION >= 0x70000
#if !defined(____x_ABI_CMicrosoft_CWindows_CAI_CText_CITextRewriter3_INTERFACE_DEFINED__)
#define ____x_ABI_CMicrosoft_CWindows_CAI_CText_CITextRewriter3_INTERFACE_DEFINED__
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_Microsoft_Windows_AI_Text_ITextRewriter3[] = L"Microsoft.Windows.AI.Text.ITextRewriter3";
namespace ABI {
    namespace Microsoft {
        namespace Windows {
            namespace AI {
                namespace Text {
                    MIDL_INTERFACE("622eb80a-ed1a-5525-80d8-c6e80236a195")
                    ITextRewriter3 : public IInspectable
                    {
                    public:
                        virtual HRESULT STDMETHODCALLTYPE RewriteCustomAsync(
                            HSTRING text,
                            HSTRING customTone,
                            __FIAsyncOperationWithProgress_2_Microsoft__CWindows__CAI__CText__CLanguageModelResponseResult_HSTRING** operation
                            ) = 0;
                    ...
                    MIDL_CONST_ID IID& IID_ITextRewriter3 = _uuidof(ITextRewriter3);
                } /* Text */
            } /* AI */
        } /* Windows */
    } /* Microsoft */
...
EXTERN_C const IID IID___x_ABI_CMicrosoft_CWindows_CAI_CText_CITextRewriter3;
#endif /* !defined(____x_ABI_CMicrosoft_CWindows_CAI_CText_CITextRewriter3_INTERFACE_DEFINED__) */
#endif // MICROSOFT_WINDOWS_AI_TEXT_TEXTINTELLIGENCECONTRACT_VERSION >= 0x70000
 ...
 *    Microsoft.Windows.AI.Text.ITextRewriter3
 *
 * Class Threading Model:  Both Single and Multi Threaded Apartment
 *
 * Class Marshaling Behavior:  Agile - Class is agile
...
#ifndef ____x_ABI_CMicrosoft_CWindows_CAI_CText_CITextRewriter3_FWD_DEFINED__
#define ____x_ABI_CMicrosoft_CWindows_CAI_CText_CITextRewriter3_FWD_DEFINED__
typedef interface __x_ABI_CMicrosoft_CWindows_CAI_CText_CITextRewriter3 __x_ABI_CMicrosoft_CWindows_CAI_CText_CITextRewriter3;
...
#define ____x_ABI_CMicrosoft_CWindows_CAI_CText_CITextRewriter3_INTERFACE_DEFINED__
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_Microsoft_Windows_AI_Text_ITextRewriter3[] = L"Microsoft.Windows.AI.Text.ITextRewriter3";
typedef struct __x_ABI_CMicrosoft_CWindows_CAI_CText_CITextRewriter3Vtbl
{
    BEGIN_INTERFACE

    HRESULT (STDMETHODCALLTYPE* QueryInterface)(__x_ABI_CMicrosoft_CWindows_CAI_CText_CITextRewriter3* This,
        REFIID riid,
        void** ppvObject);
    ULONG (STDMETHODCALLTYPE* AddRef)(__x_ABI_CMicrosoft_CWindows_CAI_CText_CITextRewriter3* This);
    ULONG (STDMETHODCALLTYPE* Release)(__x_ABI_CMicrosoft_CWindows_CAI_CText_CITextRewriter3* This);
    HRESULT (STDMETHODCALLTYPE* GetIids)(__x_ABI_CMicrosoft_CWindows_CAI_CText_CITextRewriter3* This,
        ULONG* iidCount,
        IID** iids);
    HRESULT (STDMETHODCALLTYPE* GetRuntimeClassName)(__x_ABI_CMicrosoft_CWindows_CAI_CText_CITextRewriter3* This,
        HSTRING* className);
    HRESULT (STDMETHODCALLTYPE* GetTrustLevel)(__x_ABI_CMicrosoft_CWindows_CAI_CText_CITextRewriter3* This,
        TrustLevel* trustLevel);
    HRESULT (STDMETHODCALLTYPE* RewriteCustomAsync)(__x_ABI_CMicrosoft_CWindows_CAI_CText_CITextRewriter3* This,
        HSTRING text,
        HSTRING customTone,
        __FIAsyncOperationWithProgress_2_Microsoft__CWindows__CAI__CText__CLanguageModelResponseResult_HSTRING** operation);

    END_INTERFACE
} __x_ABI_CMicrosoft_CWindows_CAI_CText_CITextRewriter3Vtbl;

interface __x_ABI_CMicrosoft_CWindows_CAI_CText_CITextRewriter3
{
    CONST_VTBL struct __x_ABI_CMicrosoft_CWindows_CAI_CText_CITextRewriter3Vtbl* lpVtbl;
};

#ifdef COBJMACROS

#define __x_ABI_CMicrosoft_CWindows_CAI_CText_CITextRewriter3_QueryInterface(This, riid, ppvObject) \
    ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))

#define __x_ABI_CMicrosoft_CWindows_CAI_CText_CITextRewriter3_AddRef(This) \
    ((This)->lpVtbl->AddRef(This))

#define __x_ABI_CMicrosoft_CWindows_CAI_CText_CITextRewriter3_Release(This) \
    ((This)->lpVtbl->Release(This))

#define __x_ABI_CMicrosoft_CWindows_CAI_CText_CITextRewriter3_GetIids(This, iidCount, iids) \
    ((This)->lpVtbl->GetIids(This, iidCount, iids))

#define __x_ABI_CMicrosoft_CWindows_CAI_CText_CITextRewriter3_GetRuntimeClassName(This, className) \
    ((This)->lpVtbl->GetRuntimeClassName(This, className))

#define __x_ABI_CMicrosoft_CWindows_CAI_CText_CITextRewriter3_GetTrustLevel(This, trustLevel) \
    ((This)->lpVtbl->GetTrustLevel(This, trustLevel))

#define __x_ABI_CMicrosoft_CWindows_CAI_CText_CITextRewriter3_RewriteCustomAsync(This, text, customTone, operation) \
    ((This)->lpVtbl->RewriteCustomAsync(This, text, customTone, operation))
