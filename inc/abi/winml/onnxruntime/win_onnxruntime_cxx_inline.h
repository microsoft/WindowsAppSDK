...
// Do not include this file directly. Please include <win_onnxruntime_cxx_api.h> instead.
// If interested in trying out features of the new experimental C++ API, include <experimental_win_onnxruntime_cxx_api.h> instead.
//
