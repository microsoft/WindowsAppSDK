...
#undef INTERFACE
#define INTERFACE ICompositorSwapChainInterop
DECLARE_INTERFACE_IID_(ICompositorSwapChainInterop, ICompositorInterop, "FC084699-67D8-40E1-ADE7-08901D84FFDA")
{
public:
    HRESULT CreateCompositionSurfaceForHandle(
        _In_ HANDLE swapChain,
        _Out_ ICompositionSurface * result)
    {
        return CreateCompositionSurfaceForHandle_Abi(
            swapChain,
            winrt::put_abi(*result));
    }
    ...
    HRESULT CreateCompositionSurfaceForSwapChain(
        ...
        _Out_ ICompositionSurface * result)
    {
        return CreateCompositionSurfaceForSwapChain_Abi(
            swapChain,
            winrt::put_abi(*result));
    }

private:
    IFACEMETHOD(CreateCompositionSurfaceForHandle_Abi)(
        _In_ HANDLE swapChain,
        _COM_Outptr_ void** result // ICompositionSurface**
        ) PURE;

    IFACEMETHOD(CreateCompositionSurfaceForSwapChain_Abi)(
        _In_ ::IUnknown * swapChain,
        _COM_Outptr_ void** result // ICompositionSurface**
        ) PURE;
};
