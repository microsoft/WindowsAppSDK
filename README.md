...
1.1 is [available today](https://docs.microsoft.com/windows/apps/windows-app-sdk/) and includes unpackaged support with WinUI 3, single-project templates, and more!
