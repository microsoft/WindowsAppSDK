...
2. **Build**: Run `BuildAll.ps1` and check for exit code 0
...
- Use `.github/skills/worktree-manager/scripts/New-WorktreeFromBranch.ps1` for isolated worktrees
...
- [Coding Guidelines](../../docs/Coding-Guidelines.md) — Formatting and conventions
