---
agent: 'agent'
description: 'Generate a well-structured pull request description from the local diff'
---

# Generate PR Summary

**Goal:** Produce a ready-to-paste PR title and description that follows repository conventions by comparing the current branch against a user-selected target branch.
