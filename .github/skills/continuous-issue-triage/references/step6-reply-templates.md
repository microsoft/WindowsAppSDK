...
{{#IF_MISSING_VERSION}}
**Environment Details**
- SDK/product version (Settings > General > Version):
...
{{#IF_RELEASED}}
✅ **The fix is now available in v{{VERSION}}**
...
- WinGet: `(install latest release)`
{{/IF_RELEASED}}

{{#IF_NOT_RELEASED}}
The fix has been merged and will be included in the next release (v{{NEXT_VERSION}}).

You can track the release progress in our [milestones](https://github.com/{{OWNER}}/{{REPO}}/milestones).
{{/IF_NOT_RELEASED}}

Thank you for reporting this issue and helping improve this project! 🙏
