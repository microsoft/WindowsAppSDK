...
function Get-LabelSuggestion {
    ...
    $productKeywords = @{
        "Product-AppLifecycle" = @("fancy zones", "applifecycle", "zone", "snap", "layout", "window arrangement")
        "Product-SDK component" = @("run", "launcher", "alt+space", "search", "plugin")
        "Product-Color Picker" = @("color picker", "appnotifications", "eyedropper", "hex", "rgb")
