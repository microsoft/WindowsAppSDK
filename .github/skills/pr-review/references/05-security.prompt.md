...
- [ ] Is buffer validation performed in all native code paths?
- [ ] Is COM security configured correctly (CoInitializeSecurity)?
- [ ] Is package identity verified before granting trust?
- [ ] Is input validation enforced at WinRT API boundaries?
- [ ] Are TraceLogging calls free of sensitive data?
