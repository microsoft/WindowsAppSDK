...
- [ ] Are WinRT async patterns used correctly (co_await, IAsyncOperation)?
- [ ] Is COM marshaling overhead minimized (avoid unnecessary cross-apartment calls)?
- [ ] Is C++ memory managed via RAII and WIL smart pointers (wil::unique_*, wil::com_ptr)?
- [ ] Are cross-apartment calls avoided on hot paths?
