...
- [ ] Are UIA provider interfaces implemented correctly for custom controls?
- [ ] Are automation peer patterns followed for SDK-provided UI elements?
- [ ] Is high-contrast mode supported in any SDK-provided UI components?
- [ ] Are accessibility properties propagated through WinRT component boundaries?
