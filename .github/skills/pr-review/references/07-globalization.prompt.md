...
- [ ] Is ICU used correctly for locale-sensitive text processing in the SDK?
- [ ] Is BiDi text handled properly in any SDK-provided UI components?
- [ ] Are date/time formats using Windows.Globalization APIs?
- [ ] Are string comparisons in SDK APIs using appropriate culture/ordinal semantics?
