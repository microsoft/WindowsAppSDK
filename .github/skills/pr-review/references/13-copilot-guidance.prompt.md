...
## Repo-specific guidance checks
- [ ] Is guidance aligned with AGENTS.md?
- [ ] Is guidance consistent with .github/copilot-instructions.md?
- [ ] Are skill scripts well-structured and tested?
- [ ] Is build and test guidance accurate for the WinAppSDK repo?
...
Follow the patterns in docs/development/logging.md.

# BAD: Hardcoded paths
Edit the file at an absolute path like C:\repo\src\...

# GOOD: Relative/generic paths
Edit the file at dev/&lt;area&gt;/...
```
