...
- [ ] Are new strings added to .resw files using MRT Core (MrtCore) resource patterns?
- [ ] Are resource URIs following the `ms-resource:///` convention?
- [ ] Is locale fallback handled correctly through the MRT resource pipeline?
- [ ] Are resource map lookups using the correct resource subtree?
