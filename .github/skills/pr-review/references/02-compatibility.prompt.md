...
- [ ] Is the minimum OS version (Windows 10 17763 / 1809) respected?
- [ ] Are WinRT API additions additive-only (no removal or signature changes)?
- [ ] Is backward compatibility preserved for existing NuGet package consumers?
- [ ] Is platform support maintained for x64, x86, and ARM64?
