...
- Analyze issue type, component, and severity to suggest missing or incorrect labels
- Recommend labels from: `bug`, `enhancement`, `documentation`, `question`, `duplicate`, `needs-triage`, `needs-author-feedback`, `area-<ComponentName>`, etc.
...
- Suggest 2-3 potential assignees with context: `@<username> - <reason>` (e.g., "fixed similar issue in #12345", "maintains AppLifecycle component")
