...
PublishFile $FullBuildOutput\WindowsAppRuntime_DLL\StrippedWinMD\Microsoft.Foundation.winmd $FullPublishDir\Microsoft.WindowsAppRuntime\
...
#
# WinMD for UWP apps
PublishFile $FullBuildOutput\WindowsAppRuntime_DLL\StrippedWinMD\Microsoft.Foundation.winmd $NugetDir\lib\uap10.0
