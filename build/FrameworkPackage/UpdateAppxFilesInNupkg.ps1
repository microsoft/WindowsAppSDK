...
{
    $search = "UAPSignedBinary_Microsoft.ProjectReunion.*.$flavor.appx"
...
$nuspec = Join-Path $nugetUnpacked "Microsoft.ProjectReunion.nuspec"
...
$outputFile = Get-ChildItem $nugetUnpacked -Filter "Microsoft.ProjectReunion.*.nupkg"
