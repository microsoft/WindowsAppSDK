...
cp dev/MRTCore/mrt/packages/Microsoft.Taef.Redist.Wlk.10.57.200918006-develop/build/Binaries/$Platform/* $payloadDir

cp dev/MRTCore/mrt/packages/Microsoft.Taef.Redist.Wlk.10.57.200918006-develop/build/Binaries/$Platform/netstandard2.0/* $payloadDir
