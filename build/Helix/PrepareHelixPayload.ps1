...
cp dev/MRTCore/mrt/packages/Microsoft.Taef.*/build/Binaries/$Platform/* $payloadDir

cp dev/MRTCore/mrt/packages/Microsoft.Taef.*/build/Binaries/$Platform/netstandard2.0/* $payloadDir
