...
$taefExe = "$TestBinaryDirectoryPath\te.exe"
$taefListPropertiesCommand = "$taefExe /listproperties $runIgnoredTestsStr $TaefSelectStatement $TestFilePathPattern".Replace("`"", "`"`"`"")
