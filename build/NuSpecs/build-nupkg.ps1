...
Copy-IntoNewDirectory -IfExists $BuildOutput\$BuildFlavor\x86\Microsoft.Project.Reunion\Microsoft.Project.Reunion.dll "$runtimesDir\win10-x86\native"
Copy-IntoNewDirectory -IfExists $BuildOutput\$BuildFlavor\x86\Microsoft.Project.Reunion\Microsoft.Project.Reunion.pri "$runtimesDir\win10-x86\native"
Copy-IntoNewDirectory -IfExists ..\..\dev\Materials\Acrylic\Assets\NoiseAsset_256x256_PNG.png "$runtimesDir\win10-x86\native\Microsoft.Project.Reunion\Assets"
Copy-IntoNewDirectory -IfExists $BuildOutput\$BuildFlavor\x64\Microsoft.Project.Reunion\Microsoft.Project.Reunion.dll "$runtimesDir\win10-x64\native"
Copy-IntoNewDirectory -IfExists $BuildOutput\$BuildFlavor\x64\Microsoft.Project.Reunion\Microsoft.Project.Reunion.pri "$runtimesDir\win10-x64\native"
Copy-IntoNewDirectory -IfExists ..\..\dev\Materials\Acrylic\Assets\NoiseAsset_256x256_PNG.png "$runtimesDir\win10-x64\native\Microsoft.Project.Reunion\Assets"
Copy-IntoNewDirectory -IfExists $BuildOutput\$BuildFlavor\arm\Microsoft.Project.Reunion\Microsoft.Project.Reunion.dll "$runtimesDir\win10-arm\native"
Copy-IntoNewDirectory -IfExists $BuildOutput\$BuildFlavor\arm\Microsoft.Project.Reunion\Microsoft.Project.Reunion.pri "$runtimesDir\win10-arm\native"
Copy-IntoNewDirectory -IfExists ..\..\dev\Materials\Acrylic\Assets\NoiseAsset_256x256_PNG.png "$runtimesDir\win10-arm\native\Microsoft.Project.Reunion\Assets"
Copy-IntoNewDirectory -IfExists $BuildOutput\$BuildFlavor\arm64\Microsoft.Project.Reunion\Microsoft.Project.Reunion.dll "$runtimesDir\win10-arm64\native"
Copy-IntoNewDirectory -IfExists $BuildOutput\$BuildFlavor\arm64\Microsoft.Project.Reunion\Microsoft.Project.Reunion.pri "$runtimesDir\win10-arm64\native"
...
if(-not $SkipFrameworkPackage)
{
    ...
    Copy-IntoNewDirectory -IfExists $BuildOutput\$BuildFlavor\x86\FrameworkPackage\Microsoft.Project.Reunion.*.appx "$toolsDir\AppX\x86\Release"
    Copy-IntoNewDirectory -IfExists $BuildOutput\$BuildFlavor\x64\FrameworkPackage\Microsoft.Project.Reunion.*.appx "$toolsDir\AppX\x64\Release"
    Copy-IntoNewDirectory -IfExists $BuildOutput\$BuildFlavor\arm\FrameworkPackage\Microsoft.Project.Reunion.*.appx "$toolsDir\AppX\arm\Release"
    Copy-IntoNewDirectory -IfExists $BuildOutput\$BuildFlavor\arm64\FrameworkPackage\Microsoft.Project.Reunion.*.appx "$toolsDir\AppX\arm64\Release"
    # Currently we don't have a separate Debug package that we want to ship to customers
    #Copy-IntoNewDirectory -IfExists $BuildOutput\debug\x86\FrameworkPackage\Microsoft.Project.Reunion.Debug.*.appx "$toolsDir\AppX\x86\Debug"
    #Copy-IntoNewDirectory -IfExists $BuildOutput\debug\x64\FrameworkPackage\Microsoft.Project.Reunion.Debug.*.appx "$toolsDir\AppX\x64\Debug"
    #Copy-IntoNewDirectory -IfExists $BuildOutput\debug\arm\FrameworkPackage\Microsoft.Project.Reunion.Debug.*.appx "$toolsDir\AppX\arm\Debug"
    #Copy-IntoNewDirectory -IfExists $BuildOutput\debug\arm64\FrameworkPackage\Microsoft.Project.Reunion.Debug.*.appx "$toolsDir\AppX\arm64\Debug"
