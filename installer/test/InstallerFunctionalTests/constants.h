...
namespace ProjectReunionInstallerTests
{
    ...
    static const std::wstring c_arm64MainName = L"ProjectReunion.Test.Main_1.0.0.0_arm64__8wekyb3d8bbwe";
    static const std::wstring c_mainFamilyName = L"ProjectReunion.Test.Main_8wekyb3d8bbwe";

    static const std::wstring c_x86DDLMName = L"ProjectReunion.Test.DDLM-x86_1.0.0.0_x86__8wekyb3d8bbwe";
    static const std::wstring c_x64DDLMName = L"ProjectReunion.Test.DDLM-x64_1.0.0.0_x64__8wekyb3d8bbwe";
    static const std::wstring c_arm64DDLMName = L"ProjectReunion.Test.DDLM-arm64_1.0.0.0_arm64__8wekyb3d8bbwe";
    static const std::wstring c_x86DDLMFamilyName = L"ProjectReunion.Test.DDLM-arm64_8wekyb3d8bbwe";
    static const std::wstring c_x64DDLMFamilyName = L"ProjectReunion.Test.DDLM-arm64_8wekyb3d8bbwe";
    static const std::wstring c_arm64DDLMFamilyName = L"ProjectReunion.Test.DDLM-arm64_8wekyb3d8bbwe";
