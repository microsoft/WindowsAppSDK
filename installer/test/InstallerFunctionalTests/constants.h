...
namespace WindowsAppSDKInstallerTests
{
    ...
    static const std::wstring c_x86FrameworkName = L"Microsoft.WindowsAppRuntime.Test.InstallerFramework_1.0.0.0_x86__8wekyb3d8bbwe";
    static const std::wstring c_x64FrameworkName = L"Microsoft.WindowsAppRuntime.Test.InstallerFramework_1.0.0.0_x64__8wekyb3d8bbwe";
    static const std::wstring c_arm64FrameworkName = L"Microsoft.WindowsAppRuntime.Test.InstallerFramework_1.0.0.0_arm64__8wekyb3d8bbwe";
